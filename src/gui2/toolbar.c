...
#include <gretl/pixmaps/mini.tex.xpm>
#include <gretl/pixmaps/mail_16.xpm>
#include <gretl/pixmaps/mini.tsplot.xpm>
#include <gretl/pixmaps/mini.boxplot.xpm>
#include <gretl/pixmaps/mini.pdf.xpm>
#include <gretl/pixmaps/mini.manual.xpm>
#include <gretl/pixmaps/mini.pin.xpm>
#include <gretl/pixmaps/mini.alpha.xpm>
#include <gretl/pixmaps/mini.en.xpm>
#include <gretl/pixmaps/mini.split_h.xpm>
#include <gretl/pixmaps/mini.split_v.xpm>
#include <gretl/pixmaps/mini.winlist.xpm>
#include <gretl/pixmaps/mini.spreadsheet.xpm>

/* for main-window toolbar */
#include <gretl/pixmaps/mini.calc.xpm>
#include <gretl/pixmaps/mini.sh.xpm>
#include <gretl/pixmaps/mini.session.xpm>
#include <gretl/pixmaps/mini.plot.xpm>
#include <gretl/pixmaps/mini.model.xpm>
#include <gretl/pixmaps/mini.func.xpm>
#include <gretl/pixmaps/mini.db.xpm>

/* for window-finder */
#include <gretl/pixmaps/mini.gretl.xpm>
#include <gretl/pixmaps/mini.table.xpm>
#include <gretl/pixmaps/mini.page.xpm>
#include <gretl/pixmaps/mini.tools.xpm>

/* for plot bar */
#include <gretl/pixmaps/upsize.xpm>
#include <gretl/pixmaps/downsize.xpm>
