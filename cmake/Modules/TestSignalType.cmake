...
IF(NOT DEFINED CMAKE_TEST_SIGNAL_TYPE)
  ...
  configure_file("${CMAKE_SOURCE_DIR}/cmake/Modules/TestSignalType.c.in"
                 "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/TestSignalType.c"
                 @ONLY)
  ...
  TRY_COMPILE(CMAKE_TEST_SIGNAL_TYPE
    ...
    COPY_FILE "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/TestSignalType.bin")
